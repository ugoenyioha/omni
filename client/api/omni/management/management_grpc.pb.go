...
const (
	...
	ManagementService_PushToMatchbox_FullMethodName             = "/management.ManagementService/PushToMatchbox"
)
...
type ManagementServiceClient interface {
	...
	PushToMatchbox(ctx context.Context, in *PushToMatchboxRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[PushToMatchboxResponse], error)
}
...
func (c *managementServiceClient) PushToMatchbox(ctx context.Context, in *PushToMatchboxRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[PushToMatchboxResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ManagementService_ServiceDesc.Streams[4], ManagementService_PushToMatchbox_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[PushToMatchboxRequest, PushToMatchboxResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ManagementService_PushToMatchboxClient = grpc.ServerStreamingClient[PushToMatchboxResponse]
...
type ManagementServiceServer interface {
	...
	PushToMatchbox(*PushToMatchboxRequest, grpc.ServerStreamingServer[PushToMatchboxResponse]) error
...
func (UnimplementedManagementServiceServer) PushToMatchbox(*PushToMatchboxRequest, grpc.ServerStreamingServer[PushToMatchboxResponse]) error {
	return status.Error(codes.Unimplemented, "method PushToMatchbox not implemented")
}
...
func _ManagementService_PushToMatchbox_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(PushToMatchboxRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ManagementServiceServer).PushToMatchbox(m, &grpc.GenericServerStream[PushToMatchboxRequest, PushToMatchboxResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ManagementService_PushToMatchboxServer = grpc.ServerStreamingServer[PushToMatchboxResponse]
...
var ManagementService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "PushToMatchbox",
			Handler:       _ManagementService_PushToMatchbox_Handler,
			ServerStreams: true,
		},
	},
