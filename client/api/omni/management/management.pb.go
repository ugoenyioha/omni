...
type PushToMatchboxRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Same fields as CreateSchematicRequest for generating the schematic
	Extensions               []string                                        `protobuf:"bytes,1,rep,name=extensions,proto3" json:"extensions,omitempty"`
	ExtraKernelArgs          []string                                        `protobuf:"bytes,2,rep,name=extra_kernel_args,json=extraKernelArgs,proto3" json:"extra_kernel_args,omitempty"`
	MetaValues               map[uint32]string                               `protobuf:"bytes,3,rep,name=meta_values,json=metaValues,proto3" json:"meta_values,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	TalosVersion             string                                          `protobuf:"bytes,4,opt,name=talos_version,json=talosVersion,proto3" json:"talos_version,omitempty"`
...
func (x *PushToMatchboxRequest) Reset() {
	*x = PushToMatchboxRequest{}
	mi := &file_omni_management_management_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PushToMatchboxRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PushToMatchboxRequest) ProtoMessage() {}

func (x *PushToMatchboxRequest) ProtoReflect() protoreflect.Message {
	mi := &file_omni_management_management_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PushToMatchboxRequest.ProtoReflect.Descriptor instead.
func (*PushToMatchboxRequest) Descriptor() ([]byte, []int) {
	return file_omni_management_management_proto_rawDescGZIP(), []int{32}
}

func (x *PushToMatchboxRequest) GetExtensions() []string {
	if x != nil {
		return x.Extensions
	}
	return nil
...
func (x *PushToMatchboxRequest) GetExtraKernelArgs() []string {
	if x != nil {
		return x.ExtraKernelArgs
	}
	return nil
...
func (x *PushToMatchboxRequest) GetMetaValues() map[uint32]string {
	if x != nil {
		return x.MetaValues
	}
	return nil
...
func (x *PushToMatchboxRequest) GetTalosVersion() string {
	if x != nil {
		return x.TalosVersion
	}
	return ""
...
func (x *PushToMatchboxRequest) GetMediaId() string {
	if x != nil {
		return x.MediaId
	}
	return ""
...
func (x *PushToMatchboxRequest) GetSecureBoot() bool {
	if x != nil {
		return x.SecureBoot
	}
	return false
...
func (x *PushToMatchboxRequest) GetSiderolinkGrpcTunnelMode() CreateSchematicRequest_SiderolinkGRPCTunnelMode {
	if x != nil {
		return x.SiderolinkGrpcTunnelMode
	}
	return CreateSchematicRequest_AUTO
...
func (x *PushToMatchboxRequest) GetJoinToken() string {
	if x != nil {
		return x.JoinToken
	}
	return ""
...
type PushToMatchboxResponse struct {
	state         protoimpl.MessageState           `protogen:"open.v1"`
	Progress      *PushToMatchboxResponse_Progress `protobuf:"bytes,1,opt,name=progress,proto3" json:"progress,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PushToMatchboxResponse) Reset() {
	*x = PushToMatchboxResponse{}
	mi := &file_omni_management_management_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PushToMatchboxResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PushToMatchboxResponse) ProtoMessage() {}

func (x *PushToMatchboxResponse) ProtoReflect() protoreflect.Message {
	mi := &file_omni_management_management_proto_msgTypes[33]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PushToMatchboxResponse.ProtoReflect.Descriptor instead.
func (*PushToMatchboxResponse) Descriptor() ([]byte, []int) {
	return file_omni_management_management_proto_rawDescGZIP(), []int{33}
}

func (x *PushToMatchboxResponse) GetProgress() *PushToMatchboxResponse_Progress {
	if x != nil {
		return x.Progress
	}
	return nil
...
type PushToMatchboxResponse_Progress struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PushToMatchboxResponse_Progress) Reset() {
	*x = PushToMatchboxResponse_Progress{}
	mi := &file_omni_management_management_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PushToMatchboxResponse_Progress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PushToMatchboxResponse_Progress) ProtoMessage() {}

func (x *PushToMatchboxResponse_Progress) ProtoReflect() protoreflect.Message {
	mi := &file_omni_management_management_proto_msgTypes[41]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PushToMatchboxResponse_Progress.ProtoReflect.Descriptor instead.
func (*PushToMatchboxResponse_Progress) Descriptor() ([]byte, []int) {
	return file_omni_management_management_proto_rawDescGZIP(), []int{33, 0}
}

func (x *PushToMatchboxResponse_Progress) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *PushToMatchboxResponse_Progress) GetPercentage() int32 {
	if x != nil {
		return x.Percentage
	}
	return 0
...
func (x *PushToMatchboxResponse_Progress) GetComplete() bool {
	if x != nil {
		return x.Complete
	}
	return false
...
func (x *PushToMatchboxResponse_Progress) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
const file_omni_management_management_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\"\xf2\x03\n" +
	"\x15PushToMatchboxRequest\x12\x1e\n" +
	"\n" +
	"extensions\x18\x01 \x03(\tR\n" +
	"extensions\x12*\n" +
	"\x11extra_kernel_args\x18\x02 \x03(\tR\x0fextraKernelArgs\x12R\n" +
	"\vmeta_values\x18\x03 \x03(\v21.management.PushToMatchboxRequest.MetaValuesEntryR\n" +
	"metaValues\x12#\n" +
	"\rtalos_version\x18\x04 \x01(\tR\ftalosVersion\x12\x19\n" +
	"\bmedia_id\x18\x05 \x01(\tR\amediaId\x12\x1f\n" +
	"\vsecure_boot\x18\x06 \x01(\bR\n" +
	...
	"\x16PushToMatchboxResponse\x12G\n" +
	"\bprogress\x18\x01 \x01(\v2+.management.PushToMatchboxResponse.ProgressR\bprogress\x1av\n" +
	"\bProgress\x12\x18\n" +
	...
	"\x05error\x18\x04 \x01(\tR\x05error2\xf7\r\n" +
	...
	"\x0fCreateJoinToken\x12\".management.CreateJoinTokenRequest\x1a#.management.CreateJoinTokenResponse\x12Y\n" +
	"\x0ePushToMatchbox\x12!.management.PushToMatchboxRequest\x1a\".management.PushToMatchboxResponse0\x01B7Z5github.com/siderolabs/omni/client/api/omni/managementb\x06proto3"
...
var file_omni_management_management_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_omni_management_management_proto_goTypes = []any{
	...
	(*PushToMatchboxRequest)(nil),                                   // 35: management.PushToMatchboxRequest
	(*PushToMatchboxResponse)(nil),                                  // 36: management.PushToMatchboxResponse
	...
	nil,                                                             // 43: management.PushToMatchboxRequest.MetaValuesEntry
	(*PushToMatchboxResponse_Progress)(nil),                         // 44: management.PushToMatchboxResponse.Progress
	(*durationpb.Duration)(nil),                                     // 45: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),                                   // 46: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),                                           // 47: google.protobuf.Empty
	(*common.Data)(nil),                                             // 48: common.Data
}
var file_omni_management_management_proto_depIdxs = []int32{
	...
	45, // 1: management.KubeconfigRequest.service_account_ttl:type_name -> google.protobuf.Duration
	...
	46, // 9: management.CreateJoinTokenRequest.expiration_time:type_name -> google.protobuf.Timestamp
	43, // 10: management.PushToMatchboxRequest.meta_values:type_name -> management.PushToMatchboxRequest.MetaValuesEntry
	1,  // 11: management.PushToMatchboxRequest.siderolink_grpc_tunnel_mode:type_name -> management.CreateSchematicRequest.SiderolinkGRPCTunnelMode
	44, // 12: management.PushToMatchboxResponse.progress:type_name -> management.PushToMatchboxResponse.Progress
	38, // 13: management.ListServiceAccountsResponse.ServiceAccount.pgp_public_keys:type_name -> management.ListServiceAccountsResponse.ServiceAccount.PgpPublicKey
	46, // 14: management.ListServiceAccountsResponse.ServiceAccount.PgpPublicKey.expiration:type_name -> google.protobuf.Timestamp
	42, // 15: management.ValidateJsonSchemaResponse.Error.errors:type_name -> management.ValidateJsonSchemaResponse.Error
	15, // 16: management.ManagementService.Kubeconfig:input_type -> management.KubeconfigRequest
	8,  // 17: management.ManagementService.Talosconfig:input_type -> management.TalosconfigRequest
	47, // 18: management.ManagementService.Omniconfig:input_type -> google.protobuf.Empty
	6,  // 19: management.ManagementService.MachineLogs:input_type -> management.MachineLogsRequest
	7,  // 20: management.ManagementService.ValidateConfig:input_type -> management.ValidateConfigRequest
	26, // 21: management.ManagementService.ValidateJSONSchema:input_type -> management.ValidateJsonSchemaRequest
	9,  // 22: management.ManagementService.CreateServiceAccount:input_type -> management.CreateServiceAccountRequest
	11, // 23: management.ManagementService.RenewServiceAccount:input_type -> management.RenewServiceAccountRequest
	47, // 24: management.ManagementService.ListServiceAccounts:input_type -> google.protobuf.Empty
	13, // 25: management.ManagementService.DestroyServiceAccount:input_type -> management.DestroyServiceAccountRequest
	16, // 26: management.ManagementService.KubernetesUpgradePreChecks:input_type -> management.KubernetesUpgradePreChecksRequest
	18, // 27: management.ManagementService.KubernetesSyncManifests:input_type -> management.KubernetesSyncManifestRequest
	20, // 28: management.ManagementService.CreateSchematic:input_type -> management.CreateSchematicRequest
	22, // 29: management.ManagementService.GetSupportBundle:input_type -> management.GetSupportBundleRequest
	24, // 30: management.ManagementService.ReadAuditLog:input_type -> management.ReadAuditLogRequest
	28, // 31: management.ManagementService.MaintenanceUpgrade:input_type -> management.MaintenanceUpgradeRequest
	30, // 32: management.ManagementService.GetMachineJoinConfig:input_type -> management.GetMachineJoinConfigRequest
	33, // 33: management.ManagementService.CreateJoinToken:input_type -> management.CreateJoinTokenRequest
	35, // 34: management.ManagementService.PushToMatchbox:input_type -> management.PushToMatchboxRequest
	3,  // 35: management.ManagementService.Kubeconfig:output_type -> management.KubeconfigResponse
	4,  // 36: management.ManagementService.Talosconfig:output_type -> management.TalosconfigResponse
	5,  // 37: management.ManagementService.Omniconfig:output_type -> management.OmniconfigResponse
	48, // 38: management.ManagementService.MachineLogs:output_type -> common.Data
	47, // 39: management.ManagementService.ValidateConfig:output_type -> google.protobuf.Empty
	27, // 40: management.ManagementService.ValidateJSONSchema:output_type -> management.ValidateJsonSchemaResponse
	10, // 41: management.ManagementService.CreateServiceAccount:output_type -> management.CreateServiceAccountResponse
	12, // 42: management.ManagementService.RenewServiceAccount:output_type -> management.RenewServiceAccountResponse
	14, // 43: management.ManagementService.ListServiceAccounts:output_type -> management.ListServiceAccountsResponse
	47, // 44: management.ManagementService.DestroyServiceAccount:output_type -> google.protobuf.Empty
	17, // 45: management.ManagementService.KubernetesUpgradePreChecks:output_type -> management.KubernetesUpgradePreChecksResponse
	19, // 46: management.ManagementService.KubernetesSyncManifests:output_type -> management.KubernetesSyncManifestResponse
	21, // 47: management.ManagementService.CreateSchematic:output_type -> management.CreateSchematicResponse
	23, // 48: management.ManagementService.GetSupportBundle:output_type -> management.GetSupportBundleResponse
	25, // 49: management.ManagementService.ReadAuditLog:output_type -> management.ReadAuditLogResponse
	29, // 50: management.ManagementService.MaintenanceUpgrade:output_type -> management.MaintenanceUpgradeResponse
	31, // 51: management.ManagementService.GetMachineJoinConfig:output_type -> management.GetMachineJoinConfigResponse
	34, // 52: management.ManagementService.CreateJoinToken:output_type -> management.CreateJoinTokenResponse
	36, // 53: management.ManagementService.PushToMatchbox:output_type -> management.PushToMatchboxResponse
